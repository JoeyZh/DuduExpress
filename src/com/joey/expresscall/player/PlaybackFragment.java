package com.joey.expresscall.player;
...
public class PlaybackFragment extends DialogFragment {
    ...
    public PlaybackFragment newInstance(FileBean item) {
...
//        item = getArguments().getParcelable(ARG_ITEM);
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        ColorFilter filter = new LightingColorFilter
                (getResources().getColor(R.color.blue_light), getResources().getColor(R.color.blue_light));
        ...
        mPlayButton = (ImageButton) view.findViewById(R.id.fab_play);
        ...
        mFileNameTextView.setText(item.getExtraName());
