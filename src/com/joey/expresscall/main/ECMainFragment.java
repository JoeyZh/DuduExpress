...
public class ECMainFragment extends BaseFragment {
    ...
    private final String keys[] = new String[]{"type",
            "description", "callTime", "extra", "color"};
...
//		初始化头部
        ...
        imgBtnSetting = (ImageButton)currentView.findViewById(R.id.btn_user_setting);
    ...
    private void getCallList() {
        ECCallManager.getInstance().getGroupCallList(callPageNum,PAGE_SIZE,new ResponseListener<JSONObject>() {
